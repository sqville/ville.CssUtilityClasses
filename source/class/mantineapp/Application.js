  ...
  members :
  {
    ...
    main()
    {
      ...
      */
      ...
      centerbox.setCssUtilityClass("m_1b7284a3 ville-mantineapp-LoginCenterBox");
      ...
      var LoginAuthGroupbox = new qx.ui.container.Composite(new qx.ui.layout.Basic());
      LoginAuthGroupbox.setCssUtilityClass("m_4081bf90 mantine-Group-root");
      LoginAuthGroupbox.setExcludeBoundsFromDom(true);
      LoginAuthGroupbox.setClearAllInlineStyles(true);
      LoginAuthGroupbox.getContentElement().setAttribute("data-grow", "true");

      // Google Button
      var btninnergoogle = `<span class="m_80f1301b mantine-Button-inner"><span class="m_811560b9 mantine-Button-label">Google</span></span>`;
      var googleButton = new mantineapp.components.Button(btninnergoogle, true);
      ...
      // Twitter Button
      var btninnertwit = `<span class="m_80f1301b mantine-Button-inner"><span class="m_811560b9 mantine-Button-label">Twitter</span></span>`;
      var twitButton = new mantineapp.components.Button(btninnertwit, true);
      ...
      separatorbox.setCssUtilityClass("m_3eebeb36 mantine-Divider-root");
      separatorbox.setExcludeBoundsFromDom(true);
      separatorbox.setClearAllInlineStyles(true);
      separatorbox.getContentElement().setAttribute("data-orientation", "horizontal");
      separatorbox.getContentElement().setAttribute("data-with-label", "true");
      separatorbox.getContentElement().setAttribute("role", "separator");
      separatorbox.getContentElement().setAttribute("html",'<span class="m_9e365f20 mantine-Divider-label" data-position="center">Or continue with email</span>');
