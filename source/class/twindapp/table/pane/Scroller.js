 ...
 */
qx.Class.define("twindapp.table.pane.Scroller", {
    ...
    */
    ...
    construct(table) {
      ...
      //SQ this._add(this.__top, { row: 0, column: 0, colSpan: 2 });
      ...
      //SQ this._headerClipper.addListener("pointerup", this._onPointerupHeader, this);
      //SQ this._headerClipper.addListener("tap", this._onTapHeader, this);
      
      //SQ this.__top.add(this._headerClipper, { flex: 1 });
  
      // embed pane into a scrollable container
      this._paneClipper = this._createPaneClipper();
      this._paneClipper.add(this.__tablePane);
  
      //SQ  this._paneClipper.addListener("roll", this._onRoll, this);
      //SQ  this._paneClipper.addListener("pointermove", this._onPointermovePane, this);
      //SQ  this._paneClipper.addListener("pointerdown", this._onPointerdownPane, this);
    ...
    */
    ...
    members: {
      ...
      _getRowForPagePos(pageX, pageY) {
        ...
        var headerRowHeight = this.__tablePane.getRenderedHeaderRowHeight();
  
        if (pageY >= (panePos.top + headerRowHeight) && pageY <= panePos.bottom) {
          ...
          var tableY = pageY - (panePos.top + headerRowHeight);
        ...
        var headerPos = panePos;
        headerPos.bottom = headerPos.top + headerRowHeight;
