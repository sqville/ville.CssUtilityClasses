 ...
 */
qx.Class.define("twindapp.table.cellrenderer.Default", {
  ...
  */
  ...
  members: {
    ...
    _getContentHtml(cellInfo) {
      ...
      return `<a onclick="event.preventDefault();" class="flex items-center px-6 py-4 focus:text-indigo-500" href="/user/90/edit">${cellval}</a>`;
    },
