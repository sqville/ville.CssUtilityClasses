 ...
 */
qx.Theme.define("ville.cssuc.theme.middleman.Appearance", {
  ...
  appearances: {
    ...
    */
    ...
    "dragdrop-cursor": {
      style(states) {
        ...
        return {
          source: ville.cssuc.theme.middleman.Image.URLS["cursor-" + icon],
          position: "right-top",
          offset: [2, 16, 2, 6]
        };
      }
    ...
    */
    ...
    "slidebar/button-forward": {
      ...
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS[
    ...
    "table/column-button": {
      ...
      style(states) {
        return {
          ...
          padding: 3,
          icon: ville.cssuc.theme.middleman.Image.URLS["select-column-order"]
        };
      }
    },
      ...
      style(states) {
        return {
          ...
          sortIcon: states.sorted
            ? ville.cssuc.theme.middleman.Image.URLS[
    ...
    */
    ...
    "treevirtual-line": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-line"]
        };
      }
    },
    ...
    "treevirtual-contract": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["tree-minus"]
        };
      }
    },
    ...
    "treevirtual-expand": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["tree-plus"]
        };
      }
    },
    ...
    "treevirtual-only-contract": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-minus-only"]
        };
      }
    },
    ...
    "treevirtual-only-expand": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-plus-only"]
        };
      }
    },
    ...
    "treevirtual-start-contract": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-minus-start"]
        };
      }
    },
    ...
    "treevirtual-start-expand": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-plus-start"]
        };
      }
    },
    ...
    "treevirtual-end-contract": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-minus-end"]
        };
      }
    },
    ...
    "treevirtual-end-expand": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-plus-end"]
        };
      }
    },
    ...
    "treevirtual-cross-contract": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-minus-cross"]
        };
      }
    },
    ...
    "treevirtual-cross-expand": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-plus-cross"]
        };
      }
    },
    ...
    "treevirtual-end": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-end"]
        };
      }
    },
    ...
    "treevirtual-cross": {
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["treevirtual-cross"]
        };
      }
    },
    ...
    */
    ...
    "scrollbar/button": {
      style(states) {
        ...
        styles.icon = ville.cssuc.theme.middleman.Image.URLS["arrow-" + icon];
   ...
   /* SQUpdate
    ...
    radiobutton: {
      style(states) {
        ...
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["blank"]
        };
      }
    },*/
    radiobutton: {},
    ...
    */
    ...
    checkbox: {
      ...
      style(states) {
        ...
        // Checked
        if (states.checked) {
          icon = ville.cssuc.theme.middleman.Image.URLS["checkbox-checked"];
          // Undetermined
        } else if (states.undetermined) {
          icon = ville.cssuc.theme.middleman.Image.URLS["checkbox-undetermined"];
          // Unchecked
        } else {
          // empty icon
          icon = ville.cssuc.theme.middleman.Image.URLS["blank"];
    ...
    */
    ...
    "spinner/upbutton": {
      ...
      style(states) {
        ...
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["arrow-up-small"],
          decorator: decorator,
          width: 17
        };
      }
    ...
    "spinner/downbutton": {
      ...
      style(states) {
        ...
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["arrow-down-small"],
          decorator: decorator,
          width: 17
        };
      }
    ...
    */
    ...
    "selectbox/arrow": {
      ...
      style(states) {
        return {
          source: ville.cssuc.theme.middleman.Image.URLS["arrow-down"],
          paddingRight: 4,
          paddingLeft: 5
        };
      }
    ...
    */
    ...
    "combobox/button": {
      ...
      style(states) {
        ...
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["arrow-down"],
          decorator: decorator,
          padding: [0, 5],
          width: 19
        };
      ...
      style(states) {
        return {
          source: states.opened
            ? ville.cssuc.theme.middleman.Image.URLS["tree-minus"]
            : ville.cssuc.theme.middleman.Image.URLS["tree-plus"]
        };
      }
    },
    ...
    */
    ...
    "window/minimize-button": {
      ...
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["window-minimize"],
          padding: [1, 2],
          cursor: states.disabled ? undefined : "pointer"
        };
      }
    ...
    "window/restore-button": {
      ...
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["window-restore"],
          padding: [1, 2],
          cursor: states.disabled ? undefined : "pointer"
        };
      }
    ...
    "window/maximize-button": {
      ...
      style(states) {
        return {
          icon: ville.cssuc.theme.middleman.Image.URLS["window-maximize"],
          padding: [1, 2],
          cursor: states.disabled ? undefined : "pointer"
        };
      }
    ...
    "window/close-button": {
      ...
      style(states) {
        return {
          marginLeft: 2,
          icon: ville.cssuc.theme.middleman.Image.URLS["window-close"],
          padding: [1, 2],
          cursor: states.disabled ? undefined : "pointer"
        };
      }
    ...
    */
    ...
    "datechooser/button": {
      style(states) {
        ...
        if (states.lastYear) {
          result.icon = ville.cssuc.theme.middleman.Image.URLS["arrow-rewind"];
        } else if (states.lastMonth) {
          result.icon = ville.cssuc.theme.middleman.Image.URLS["arrow-left"];
        } else if (states.nextYear) {
          result.icon = ville.cssuc.theme.middleman.Image.URLS["arrow-forward"];
        } else if (states.nextMonth) {
          result.icon = ville.cssuc.theme.middleman.Image.URLS["arrow-right"];
        }
    ...
    */
    ...
    "tabview-page/button/close-button": {
      ...
      style(states) {
        return {
          cursor: states.disabled ? undefined : "pointer",
          icon: ville.cssuc.theme.middleman.Image.URLS["tabview-close"]
        };
      }
    },
