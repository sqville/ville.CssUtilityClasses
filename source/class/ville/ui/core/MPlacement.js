 ...
 */
qx.Mixin.define("ville.ui.core.MPlacement", {
  statics: {
    __visible: null,
    __direction: "left",
  ...
  members: {
     ...
     */
    _place(coords) {
      console.log("passed coords: " + coords.top);
      this.__getPlacementSize(function (size) {
        //const obj = Object.fromEntries(size);
        //const jsonString = JSON.stringify();
        //console.log(this.getLayoutParent());
        console.log("layoutparnet bounds: " + this.getLayoutParent().getBounds().height);
