 ...
 */
qx.Class.define("ville.ui.tree.TreeRaw", {
  extend: ville.ui.core.BaseWidget,
  implement: [
  ...
  */
  ...
  construct() {
    ...
    //this.__content = new qx.ui.container.Composite(new qx.ui.layout.Basic());
    this.__content = new ville.ui.layout.Container();

    this.getChildControl("pane").add(this.__content);

    this.setCssUtilityClass("m_78f70933 m_f698e191 mantine-Tree-root");
